...
public final class CloneColumnPrefix {
	private final static String[] VALUES=new String[] {"SP", "SP", "SP", "Clone","SP","Clone"};
	private final static Perspectives[] KEYS=new Perspectives[]{Perspectives.ExomePerspective,Perspectives.GenomePerspective,Perspectives.KaryotypePerspective,Perspectives.TranscriptomePerspective, Perspectives.MorphologyPerspective,Perspectives.Identity};
