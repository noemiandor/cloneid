...
--
-- Table structure for table `LiquidNitrogenBackup`
--

DROP TABLE IF EXISTS `LiquidNitrogenBackup`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `LiquidNitrogenBackup` (
  `id` varchar(30) NOT NULL,
  `vials` int(11) DEFAULT NULL,
  `date` timestamp NULL DEFAULT NULL,
  `withCompany` varchar(150) DEFAULT NULL,
  `Comment` varchar(40) DEFAULT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `LiquidNitrogenBackup_ibfk_1` FOREIGN KEY (`id`) REFERENCES `Passaging` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1652920 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Media` (
  ...
  `antibiotic3` varchar(55) DEFAULT NULL,
  `antibiotic4` varchar(55) DEFAULT NULL,
  `antibiotic3_pct` float DEFAULT '0',
  `antibiotic4_pct` float DEFAULT '0',
  PRIMARY KEY (`id`),
  ...
  KEY `Drug` (`Stressor`),
  KEY `antibiotic3` (`antibiotic3`),
  KEY `antibiotic4` (`antibiotic4`),
  ...
  CONSTRAINT `Media_ibfk_13` FOREIGN KEY (`antibiotic3`) REFERENCES `MediaIngredients` (`name`),
  CONSTRAINT `Media_ibfk_14` FOREIGN KEY (`antibiotic4`) REFERENCES `MediaIngredients` (`name`),
...
) ENGINE=InnoDB AUTO_INCREMENT=85 DEFAULT CHARSET=latin1 COMMENT='HEPES and other organic buffers can be used with many cell l';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `MorphologyPerspective`
--

DROP TABLE IF EXISTS `MorphologyPerspective`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `MorphologyPerspective` (
  `whichPerspective` varchar(30) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=264002 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Passaging` (
  ...
  `passaged_from_id1` varchar(30) DEFAULT NULL,
  `passaged_from_id2` varchar(30) DEFAULT NULL,
  ...
  `feeding16` timestamp NULL DEFAULT NULL,
  `feeding17` timestamp NULL DEFAULT NULL,
  `backup_cellCount2` double DEFAULT NULL,
  `backup_cellCount_CLONEIDV14` double DEFAULT NULL,
  `correctedCount` double DEFAULT NULL,
  `areaOccupied_um2` double DEFAULT NULL,
  `cellSize_um2` double DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=259737 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `QuPathEvaluation`
--

DROP TABLE IF EXISTS `QuPathEvaluation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `QuPathEvaluation` (
  ...
  `feeding15` timestamp NULL DEFAULT NULL,
  `flask` int(11) DEFAULT NULL,
  `cellCount_brightnessCorrection` double DEFAULT NULL,
  `cellCount_brightnessCorrection2` double DEFAULT NULL,
  `cellCount_standard` double DEFAULT NULL,
  `cellCount_brightnessCorrection2_g65` double DEFAULT NULL,
  `cellCount_cellpose` double DEFAULT NULL,
  `cellCount_cellpose_g65` double DEFAULT NULL,
  `cellCount_cellpose_flowThresh80` double DEFAULT NULL,
  `cellCount_cellpose_g65_flowThresh80` double DEFAULT NULL,
  `cellCount_cellpose_HGC27` double DEFAULT NULL,
  `cellCount_QCmetrics` double DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-04-12 15:34:39
